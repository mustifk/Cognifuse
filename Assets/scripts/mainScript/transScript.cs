...
public class transScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        instructions[6][0] = "Shape Match";
        instructions[6][1] = "Find the correct shapes among all and select them!";
        instructions[7][0] = "Double Dribble";
        instructions[7][1] = "Catch the circles with the same color and avoid vice versa!";
        instructions[8][0] = "Color Confusion";
        instructions[8][1] = "Result is correct iff text in left part is the color of the right part!";
        instructions[9][0] = "Match The Cards";
        instructions[9][1] = "Try to find the other twin of all the cards on the screen!";
        instructions[10][0] = "Word Quest";
        instructions[10][1] = "Try to find the hidden words written on the left before the time is up!";
        instructions[11][0] = "Which One";
        instructions[11][1] = "Watch carefully to catch the one which was't on the previous screen!";
        instructions[12][0] = "Number Rush";
        instructions[12][1] = "Try to collect all numbers in order, avoid the enemies!";
        instructions[13][0] = "Paint The Shape";
        instructions[13][1] = "Try to figure out the final shape when the shapes on left and right become one!";
        instructions[14][0] = "Simon Says";
        instructions[14][1] = "Wait for the buttons to blink, then push them in the correct order!";
